				...
				<!-- Main -->
					<article id="main">
						<header>
							<h2>사이트소개</h2>
							<p>간략 설명</p>
							<a href="#one" class="more scrolly">사이트 소개</a>
							<a href="#two" class="more scrolly">사이트 사용법</a>
						</header>
						
						<section class="wrapper style5" id="one">		<!-- 배경 색... -->
							<div class="inner">					<!-- 글자들 간격들 조절 -->
						...
						<section class="wrapper style6" id="two" >		<!-- 배경 색... -->
							<div class="inner">					<!-- 글자들 간격들 조절 -->
