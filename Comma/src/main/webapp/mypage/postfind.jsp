...
function post(zip,addr){
	...
	parent.infoCorrection_frm.post1.value=zip.substring(0,3);
	parent.infoCorrection_frm.post2.value=zip.substring(4,7);
	parent.infoCorrection_frm.addr1.value=addr;
     ...
     <table id="table_content" style="margin_top:20px;width:450px">
       <tr>
         <td>입력 : <input type=text name=dong id="dong" size=15>
             <input type=button value="find" id="postBtn">
         </td>
       </tr>
       <tr>
         <td id="postPrint"></td>
